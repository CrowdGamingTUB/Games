...
function handlePaddles() {
	...
	if (keyIsDown(87)) {
		/* move up */
		// player1Velocity -= 5;
		inputDelayState = setTimeout(InputDelay1, delay_val, -5);
	...
	if (keyIsDown(UP_ARROW)) {
		/* move up */
		// player2Velocity -= 5;
		inputDelayState = setTimeout(InputDelay2, delay_val, -5);
...
function InputDelay1(step){
	player1Velocity += step;
}

function InputDelay2(step){
	player2Velocity += step;	
}